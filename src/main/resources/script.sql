...
('The Room', '100', 'Drama', '3.6', 'R'),
('The Princess Bride', '120', 'Adventure', '8.1', 'PG'),
('The Rocky Horror Picture Show', '130', 'Comedy', '7.4', 'R');
...
SELECT id, genre, rating FROM movies WHERE genre = 'Documentary' OR genre = 'Horror';
